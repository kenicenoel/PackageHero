			...
			<html>
				...
				<body>
						<nav id ="navigation">
							...
							<a class ="link" href="allpackages.php" title = "View a list of all Packages with issues"><i class="fa fa-plane fa-fw"></i> Current issues <span><?php echo $_SESSION['availableIssuesCount'] ?></span></a>
